...
public class GrapplingGun : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (Input.GetKeyUp(KeyCode.Mouse0))
        {
            ...
            var playerController = m_rigidbody.GetComponent<PlayerController>();
    ...
    void SetGrapplePoint()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(firePoint.position, distanceVector.normalized, Mathf.Infinity, grappableLayerMask);
